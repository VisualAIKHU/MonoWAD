...
class Compose(object):
    ...
    def __call__(self, image:np.ndarray, foggy:Union[None, np.ndarray]=None,
        ...
        for t in self.transforms:
            image, foggy, p2, p3, labels, image_gt, lidar = t(image, foggy, p2, p3, labels, image_gt, lidar)
        return_list = [image, foggy, p2, p3, labels, image_gt, lidar]
        if self.is_return_all:
            return return_list
