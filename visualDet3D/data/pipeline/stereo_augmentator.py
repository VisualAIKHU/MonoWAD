...
class ConvertToFloat(object):
    ...
    """
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        return left_image.astype(np.float32), foggy if foggy is None else foggy.astype(np.float32), p2, p3, labels, image_gt, lidar
...
class Normalize(object):
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        if foggy is not None:
            ...
            foggy /= 255.0
            foggy -= np.tile(self.mean, int(foggy.shape[2]/self.mean.shape[0]))
            foggy /= np.tile(self.stds, int(foggy.shape[2]/self.stds.shape[0]))
            foggy = foggy.astype(np.float32)
        return left_image, foggy, p2, p3, labels, image_gt, lidar
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        if len(self.size) > 1:
            ...
            # pad out
                ...
                if foggy is not None:
                    foggy = np.pad(foggy, [(0, 0), (0, padW), (0, 0)], 'constant')
                if image_gt is not None:
...
class CropRight(object):
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        if righter > width:
            ...
            return left_image, foggy, p2, p3, labels
...
class FilterObject(object):
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        return left_image, foggy, p2, p3, new_labels, image_gt, lidar
...
class RandomCropToWidth(object):
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        if self.width > original_width:
            ...
            return left_image, foggy, p2, p3, labels, image_gt
...
class RandomMirror(object):
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        if random.rand() <= self.mirror_prob:
            ...
            if foggy is not None:
                foggy = foggy[:, ::-1, :]
                foggy = np.ascontiguousarray(foggy)

                left_image, foggy = foggy, left_image
            if image_gt is not None:
                image_gt = image_gt[:, ::-1]
...
class RandomWarpAffine(object):
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        if foggy is not None:
            foggy = cv2.warpAffine(foggy, affine_transform,
                                    (self.output_w, self.output_h), flags=cv2.INTER_LINEAR)
...
class RandomHue(object):
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        if random.rand() <= self.distort_prob:
            ...
            if foggy is not None:
                foggy[:, :, 0] += shift
                foggy[:, :, 0][foggy[:, :, 0] > 360.0] -= 360.0
                foggy[:, :, 0][foggy[:, :, 0] < 0.0] += 360.0
        return left_image, foggy, p2, p3, labels, image_gt, lidar
...
class ConvertColor(object):
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        if self.current == 'RGB' and self.transform == 'HSV':
            ...
            if foggy is not None:
                foggy = cv2.cvtColor(foggy, cv2.COLOR_RGB2HSV)

        # HSV --> RGB
        elif self.current == 'HSV' and self.transform == 'RGB':
            left_image = cv2.cvtColor(left_image, cv2.COLOR_HSV2RGB)
            if foggy is not None:
                foggy = cv2.cvtColor(foggy, cv2.COLOR_HSV2RGB)
...
class PhotometricDistort(object):
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        return distortion(left_image.copy(), foggy if foggy is None else foggy.copy(), p2, p3, labels, image_gt, lidar)
...
class Augmentation(object):
    ...
    def __call__(self, left_image, foggy, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        return self.augment(left_image, foggy, p2, p3, labels, image_gt, lidar)
...
class Preprocess(object):
    ...
    def __call__(self, left_image, foggy, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        left_image, foggy, p2, p3, labels, image_gt, lidar = self.preprocess(left_image, foggy, p2, p3, labels, image_gt, lidar)
...
class Shuffle(object):
    ...
    def __call__(self, left_image, foggy=None, p2=None, p3=None, labels=None, image_gt=None, lidar=None):
        ...
        for index in shuffled_indexes:
            left_image, foggy, p2, p3, labels, image_gt, lidar = self.transforms[index](left_image, foggy, p2, p3, labels, image_gt, lidar)
