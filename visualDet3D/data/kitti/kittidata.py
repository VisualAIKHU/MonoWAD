...
class KittiData:
    ...
    def __init__(self, root_dir, idx, output_dict=None):
        ...
        self.origin2_path = os.path.join(root_dir, "origin_2", idx+'.png')
        self.image3_path = os.path.join(root_dir, 'image_3', idx+'.png')
        self.foggy2_path = os.path.join(root_dir, "foggy_2", idx+'.png')
    ...
    def read_data(self):
        ...
        origin = read_image(self.origin2_path) if self.output_dict["image"] else None
        foggy = read_image(self.foggy2_path) if self.output_dict["foggy"] else None
        ...
        if 'image_3' in self.output_dict and self.output_dict['image_3']:
            ...
            return calib, origin, image_3, label, pc, foggy
        else:
            return calib, origin, label, pc, foggy
